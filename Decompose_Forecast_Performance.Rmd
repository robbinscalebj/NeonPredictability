...
sites_oxy <- crps_df|>ungroup()|>filter(variable == "oxygen")|>
                     filter(site_id != "BIGC")|>distinct(site_id)|>pull(site_id)
...
oxy_horizonXsite.preds <- predictions(crps.oxy, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_oxy, forecast_week = 15))
#oxy_horizonXsite.preds2 <- avg_predictions(crps.oxy, variables = c("site_id", "horizon"))
temp_horizonXsite.preds <- predictions(crps.temp, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_temp, forecast_week = 15))
chla_horizonXsite.preds <- predictions(crps.chla, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_chla, forecast_week = 15))
nee_horizonXsite.preds <- predictions(crps.nee, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_nee, forecast_week = 15))
le_horizonXsite.preds <- predictions(crps.le, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_le, forecast_week = 15))
rcc90_horizonXsite.preds <- predictions(crps.rcc_90, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_rcc_90, forecast_week = 15))
gcc90_horizonXsite.preds <- predictions(crps.gcc_90, exclude = c("forecast_week"), #type = "response", 
                                      newdata = expand_grid(horizon = newdata_horizons, site_id = sites_gcc_90, forecast_week = 15))
