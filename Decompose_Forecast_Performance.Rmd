...
newdata_weeks <- unique(crps_df$forecast_week)
...
oxy_horizonXsite.preds <- predictions(crps.oxy, newdata = expand_grid(horizon = newdata_horizons, site_id = sites_oxy, forecast_week = newdata_weeks))
temp_horizonXsite.preds <- predictions(crps.temp, newdata = expand_grid(horizon = newdata_horizons, site_id = sites_temp, forecast_week = newdata_weeks))
chla_horizonXsite.preds <- predictions(crps.chla, newdata = expand_grid(horizon = newdata_horizons, site_id = sites_chla, forecast_week = newdata_weeks))
nee_horizonXsite.preds <- predictions(crps.nee, newdata = expand_grid(horizon = newdata_horizons, site_id = sites_nee, forecast_week = newdata_weeks))
le_horizonXsite.preds <- predictions(crps.le, newdata = expand_grid(horizon = newdata_horizons, site_id = sites_le, forecast_week = newdata_weeks))
rcc90_horizonXsite.preds <- predictions(crps.rcc_90,  newdata = expand_grid(horizon = newdata_horizons, site_id = sites_rcc_90, forecast_week = newdata_weeks))
gcc90_horizonXsite.preds <- predictions(crps.gcc_90, newdata = expand_grid(horizon = newdata_horizons, site_id = sites_gcc_90, forecast_week = newdata_weeks))
...
attempt.p <- avg_predictions(crps.oxy) 
...
```{r}
 blah <- comb_preds_sh|>
  ...
  summarize(mean_est = median(estimate), sd_est = sd(estimate), cv = sd_est/abs(mean_est))|>
  ungroup()|>
