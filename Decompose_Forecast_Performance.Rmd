...
oxy_hoorizonXsite.pa <- plot_predictions(crps.oxy.m4a, condition = c("horizon", "site_id"), type = "response")
plotly::ggplotly(oxy_hoorizonXsite.pa)

oxy_hoorizonXsite.pa+
  theme_classic()+
  theme(legend.position = "none")+
  xlab("Forecast Horizon (days into future)")+
  ylab("Dissolved Oxygen Forecast Skill (CRPS)") #this is CRPSclim - CRPS
```
```{r loops}
# data setup
